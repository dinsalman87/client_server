    ...
    .then((data) => {
      ...
      var table = $("#dataTable").DataTable({
        ...
        columns: [
          ...
          { data: "workerEmail" },
          { data: "carNumber" },
          { data: null, defaultContent: "<button id='editBtn' class='btn btn-info'>Edit</button>" },
          { data: null, defaultContent: "<button id='deleteBtn' class='btn btn-danger'>Delete</button>" },
        ],
      });
